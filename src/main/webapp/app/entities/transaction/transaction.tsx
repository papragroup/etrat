  ...
  return (
    <div>
      <h2 id="transaction-heading">
        <Translate contentKey="etratApp.transaction.home.title">Transactions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="etratApp.transaction.home.createLabel">Create new Transaction</Translate>
        </Link>
      </h2>
        ...
        {transactionList && transactionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('rrn')}>
                  <Translate contentKey="etratApp.transaction.rrn">Rrn</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('amount')}>
                  <Translate contentKey="etratApp.transaction.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('refrence')}>
                  <Translate contentKey="etratApp.transaction.refrence">Refrence</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="etratApp.transaction.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {transactionList.map((transaction, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{transaction.type ? <Link to={`transaction-type/${transaction.type.id}`}>{transaction.type.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="etratApp.transaction.home.notFound">No Transactions found</Translate>
            </div>
          )
        )}
      </div>
