/**
 * PaymentIFBindingSoap12Stub.java
 *
...
public class PaymentIFBindingSoap12Stub extends org.apache.axis.client.Stub implements PaymentIFBindingSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("verifyTransaction");
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("verifyTransaction1");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "String_1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "String_2"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("reverseTransaction1");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "String_1"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "String_2"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
    ...
    public PaymentIFBindingSoap12Stub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PaymentIFBindingSoap12Stub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PaymentIFBindingSoap12Stub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public double verifyTransaction(String string_1, String string_2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("verifyTransaction");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:Foo", "verifyTransaction"));
 ...
 try {        Object _resp = _call.invoke(new Object[] {string_1, string_2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                ...
                return ((Double) org.apache.axis.utils.JavaUtils.convert(_resp, double.class)).doubleValue();
            }
        }
  ...
  throw axisFaultException;
    ...
    public double verifyTransaction1(String string_1, String string_2) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:Foo", "verifyTransaction1"));
 ...
 try {        Object _resp = _call.invoke(new Object[] {string_1, string_2});
  ...
  throw axisFaultException;
    ...
    public double reverseTransaction(String string_1, String string_2, String username, String password) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("reverseTransaction");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:Foo", "reverseTransaction"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {string_1, string_2, username, password});
  ...
  throw axisFaultException;
    ...
    public double reverseTransaction1(String string_1, String string_2, String password, double amount) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("reverseTransaction1");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP12_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:Foo", "reverseTransaction1"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {string_1, string_2, password, new Double(amount)});
