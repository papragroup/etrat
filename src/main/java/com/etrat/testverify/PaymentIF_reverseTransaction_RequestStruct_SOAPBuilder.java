...
public class PaymentIF_reverseTransaction_RequestStruct_SOAPBuilder implements SOAPInstanceBuilder
{
    private PaymentIF_reverseTransaction_RequestStruct _instance;
    ...
    public void setString_3(final String string_3) {
        this.string_3 = string_3;
    }

    public void setDouble_4(final double double_4) {
        this.double_4 = double_4;
    }
    ...
    public void setMember(final int n, final Object o) {
        try {
            switch (n) {
                ...
                case 2: {
                    this._instance.setString_3((String)o);
                    break;
                }
                default: {
                    throw new IllegalArgumentException();
    ...
    public void setInstance(final Object o) {
        this._instance = (PaymentIF_reverseTransaction_RequestStruct)o;
    }
